...
export default function PetitionPage() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      // Temporarily strip website styling for the PDF render
      const originalClasses = element.className;
      element.className = "bg-white p-8 max-w-[210mm] mx-auto text-[14px] leading-snug text-black";
      
      const opt = {
        margin:       15,
        filename:     `Appeal_Petition_${appealFormData?.epicNumber || 'Document'}.pdf`,
      ...
      // Restore the UI styles after download
